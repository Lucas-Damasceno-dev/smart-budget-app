    ...
    <div class="auth-page-container">
      ...
      <mat-card class="auth-card">
        ...
        <div class="form-header">
          ...
          <p class="subtitle">Comece a gerenciar suas finanças de forma inteligente</p>
        </div>
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()" class="auth-form">
          ...
          <mat-form-field appearance="outline" class="full-width">
            ...
            <input matInput formControlName="password" [type]="hidePassword ? 'password' : 'text'" placeholder="No mínimo 8 caracteres" />
          ...
          <button mat-flat-button color="primary" class="submit-btn" type="submit" [disabled]="form.invalid || (loading$ | async)">
            <ng-container *ngIf="loading$ | async; else createText">
              <mat-spinner diameter="22" class="btn-spinner"></mat-spinner>
            </ng-container>
            <ng-template #createText>Criar Conta Gratuitamente</ng-template>
          </button>
        </form>

        <div class="auth-footer">
          <p>Já possui uma conta? <a routerLink="/auth/login">Entrar na sua conta</a></p>
        </div>
      </mat-card>
    </div>
  `,
